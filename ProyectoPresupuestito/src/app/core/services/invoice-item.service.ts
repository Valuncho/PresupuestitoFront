...
export class InvoiceItemService {
  ...
  */
  getInvoiceItems() : Observable<InvoiceItem[]> {
    ...
    */
    postInvoiceItem(invoiceItem: InvoceItemRequest){
    const url = API_URL+ENDPOINTS.invoiceItem.post;
    ...
    * @returns un observable de tipo objeto
    */
    putInvoiceItem(invoiceItem: InvoceItemRequest) {
      const url = API_URL+ENDPOINTS.invoiceItem.update.replace(':id', invoiceItem.itemId!.toString());;
  ...
  deleteInvoiceItem(idInvoiceItem: number) {
    const url = API_URL+ENDPOINTS.invoiceItem.delete.replace(':id', idInvoiceItem.toString());
